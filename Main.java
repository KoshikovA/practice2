...
public class Main {
    public static void main(String[] args) {
        ...
        Talgo.setMaxVagon(10);
        Talgo.setName("Talgo");
        Talgo.setPassengers(new ArrayList<>());
        ...
        Talgo.setVagons(temp);
        {
            ArrayList<Passenger> passengers = new ArrayList<>();
            passengers.add(new Elderly("Name","Surname",77,"123456789123","N",1,Talgo,3));
            passengers.add(new Student("Bekzat","Kanay",17,"888999456123","N",1,Talgo,1));
            passengers.add(new Student("Yali","Ualikhanov",20,"998456321123","Y",1,Talgo,7));
            passengers.add((new Child("Emporio","Eniston",12,"777412365478","N",3,Talgo,10)));

            Talgo.setPassengers(passengers);
        }

        Train Tulpar = new Train();
        Tulpar.setPassengers(new  ArrayList<>());
        Tulpar.setName("Tulpar");
        ArrayList<Vagon> temp1 = new ArrayList<>();
        temp1.add(new Luxe());
        temp1.add(new Coupe());
        temp1.add(new Platskart());

        Tulpar.setVagons(temp1);
        Tulpar.setMaxVagon(3);
    ...
    private static void addPassenger(ArrayList<Train> Trains){
        ...
        while (!trainName.equalsIgnoreCase("Tulpar") && !trainName.equalsIgnoreCase("Talgo")){
            System.out.print("Enter the right name of train : ");
            trainName = in.next();
        }
        Train train = (trainName.equalsIgnoreCase("tulpar")?Trains.get(1):Trains.get(0));
    ...
    private static Train findTrain(ArrayList<Train> Trains){
        ...
        int k = in.nextInt();
        while (k!=1 && k!=2){
            System.out.print("Enter 1 to select Talgo , 2 to select Tulpar : ");
            k = in.nextInt();
        }
